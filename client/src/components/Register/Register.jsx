    ...
    return (
        <div className='Register-form'>
            ...
            <div className="register-form">
                <div>
                    <label>Họ tên</label>
                    <input type='text' className="name" placeholder='Điền tên bạn'></input>
                </div>
                ...
                <div>
                    <label>Email</label>
                    <input type='email' className="name" placeholder='123abc@gmail.com'></input>
                </div>
                ...
                <div>
                    <button className='btn-submit'>Đăng ký ngay</button>
                </div>
